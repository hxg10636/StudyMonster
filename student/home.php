          ...
          <div class="row align-items-center g-0">
              <div class="col-xl-5 col-lg-6 col-md-12">
                  <div class="py-5 py-lg-0">
                      <h1 class="text-white display-4 fw-bold">StudyMonster - A ISTM6210 Capstone Project
                      </h1>
                      ...
                      <a href="course_selected.php" class="btn btn-light">Enrolled Courses</a>
                  </div>
              </div>
                ...
                <div class='card  mb-4 card-hover popup'>
                  ...
                  <div class='card-body'>
                    ...
                    <ul class='mb-3 list-inline'>
                      ...
                      $query = "SELECT COUNT(student_id) AS nums FROM student_course WHERE student_id = ".$sname['id']." AND course_id = ".$row['course_id'];
