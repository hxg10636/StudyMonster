...
if(isset($_POST['submit'])){
    ...
    $query = "UPDATE student SET dob = '$dob', userEmails = '$email' WHERE uid = '$username'";
...
//Course information
$query = "SELECT c.course_id, c.name AS cname, duration, sc.Enrolldate, t.name AS tname FROM course c INNER JOIN student_course sc ON sc.course_id = c.course_id INNER JOIN student s ON s.id = sc.student_id INNER JOIN teacher t ON c.instructor_id = t.id WHERE s.uid = '$username'";
...
if(isset($_POST['submit1'])){
    ...
    if (is_uploaded_file($_FILES['file']['tmp_name'])){
        if(move_uploaded_file($_FILES['file']['tmp_name'] , $path.$name)){
            $query = "UPDATE student SET avatar = '$name' WHERE uid = '$username'";
            $result2 = mysqli_query($connection,$query);
            mysqli_free_result($result2);
            header('Location: dashboard.php?succsess=avatar');
        }else{
            die('Upload Failed.');
        }
    }else{
...
if(isset($_POST['submit2'])){
        ...
        $pass1 = $_POST['pass1'];
        $pass2 = $_POST['pass2'];
        $query = "SELECT pwd FROM student WHERE uid = '$username'";
        $pass = mysqli_fetch_array(mysqli_query($connection, $query));
        mysqli_free_result(mysqli_query($connection, $query));
        if($pass['pwd']==$old_pass && $pass1==$pass2){
            $query = "UPDATE student SET pwd = '$pass1' WHERE uid = '$username'";
 					...
 					<div class="card">
 						...
 						<div class="card-body">
 							<div class="d-lg-flex align-items-center justify-content-between">
 								...
 								<div>
                  <form action="dashboard.php" method="post" enctype="multipart/form-data" role="form" id="validate">
 							...
 							<div>
 								...
 								<!-- Form -->
 								<form class="row" role="form" method="post" action="dashboard.php">
 									<!-- name -->
