...
if (isset($_GET['id'])){
    ...
    //Course information
    $query = "SELECT c.name AS cname,c.course_id, c.duration, t.name AS tname FROM course c INNER JOIN teacher t ON c.instructor_id = t.id WHERE id = '$id'";
    $result = mysqli_query($connection,$query);
    
    //Student info
    $query = "SELECT id, name,uid, userEmails,avatar,dob FROM teacher WHERE id='$id'";
...
if(isset($_POST['submit'])){
    ...
    $query = "UPDATE teacher SET dob = '$dob', userEmails = '$email' WHERE id = '$id'";
    $result1 = mysqli_query($connection,$query);
    mysqli_free_result($result1);
    header("Location: teacher_details.php?id=".$id."&success=update");
}
            ...
            <li class="dropdown ms-2">
                <a class="rounded-circle" href="#" role="button" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="avatar avatar-md avatar-indicators avatar-online">
                        <img alt="avatar" src="../../assets/img/avatars/<?php echo $sname['avatar']; ?>" class="rounded-circle" />
                    </div>
                </a>
                ...
                <hr/>
                             <div class="panel panel-default plain">
                                 ...
                                 <div class="panel-heading white-bg">
                                     <h4 class="panel-title">This Teacher is teaching:</h4>
                                 </div>
