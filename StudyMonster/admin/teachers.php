...
//Teacher info
$query = "SELECT name, id, userEmails, avatar, dob  FROM teacher";
 ...
 <div class="container-fluid p-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 heading">
                    <h1 class="page-header"><i class="im-accessibility"></i>Teacher Management</h1>
                    <?php
if(isset($_GET['success'])){
   if($_GET['success']=="del"){
     echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
       <strong>Done!</strong> Teahcer Deleted!
     ...
     echo "<div class='alert alert-danger alert-dismissible fade show' role='alert'>
       <strong>Error!</strong> Cannot Delete the Teahcer!
       <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
         <span aria-hidden='true'>&times;</span>
       </button>
     </div>";
     ...
     echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
       <strong>Done!</strong> Teahcer Information Changed!
       <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
         <span aria-hidden='true'>&times;</span>
       </button>
     </div>";
                      ...
                      <table id="example" class="table table-striped" style="width:100%">
                          ...
                          <tbody>
                              ...
                              while($row=mysqli_fetch_array($result1)){
                                  ...
                                  echo "<td>".$row['id']."</td>";
                                  echo "<td>".$row['dob']."</td>";
                                  echo "<td><button class='btn btn-xs btn-primary' onclick=\"window.location.href='teacher_details.php?id=".$row['id']."'\">Edit Teacher</button></td>";
                                  echo "<td><button class='btn btn-xs btn-danger' onclick=\"window.location.href='teacher_deletion.php?id=".$row['id']."'\">Delete Teacher</button></td>";
                                  echo "</tr>";
                                  $i++;
                              }
