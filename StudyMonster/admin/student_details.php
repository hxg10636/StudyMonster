...
if (isset($_GET['id'])){
    ...
    //Course information
    $query = "SELECT sc.student_id, sc.course_id, sc.Enrolldate, c.name AS cname, c.duration, t.name AS tname, sc.grade FROM student_course sc INNER JOIN course c ON sc.course_id = c.course_id INNER JOIN teacher t ON c.instructor_id = t.id WHERE student_id = '$id'";
