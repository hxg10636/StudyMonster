                  ...
                  <thead>
                    ...
                    <tbody>
                      ...
                      while($row=mysqli_fetch_array($result)){
                          ...
                          echo "<td><img class='user-avatar' width='150' height='80' src='../assets/img/coursepic/" .$row['course_pict'] ."'></td>";
                          echo "<td><strong>".$row['cname']."</strong><br><h5>" .$row['description']. "</h5></td>";
