...
//Chosen
$query = "SELECT sc.course_id, c.name, c.duration, t.name AS tname, c.course_pict, c.description FROM course c INNER JOIN teacher t ON t.id = c.instructor_id INNER JOIN student_course sc ON sc.course_id = c.course_id INNER JOIN student s ON s.id = sc.student_id WHERE s.uid = '$username'";
...
if (isset($_POST['submit'])){
    ...
    header('Location: course_selection.php?success=1');
}
...
//Chosen
$query = "SELECT sc.course_id, sc.grade, c.name, c.duration, t.name AS tname, c.course_pict, c.description FROM course c INNER JOIN teacher t ON t.id = c.instructor_id INNER JOIN student_course sc ON sc.course_id = c.course_id INNER JOIN student s ON s.id = sc.student_id WHERE s.uid = '$username'";
$result2 = mysqli_query($connection,$query);
